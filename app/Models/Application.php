...
class Application extends Model
{
    ...
    protected $casts = [
        ...
        'driving_license_category_1' => 'boolean',
        'driving_license_category_2' => 'boolean',
        'driving_license_category_3' => 'boolean',
        'driving_license_category_4' => 'boolean',
        'driving_license_category_5' => 'boolean',
        'driving_license_category_6' => 'boolean',
