<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('messages.profile.password.description') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('messages.profile.password.current')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('messages.profile.password.new')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('messages.profile.password.confirm')" />
