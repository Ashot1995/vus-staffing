...
return [
    ...
    */
    ...
    'password' => [
        ...
        'mixed' => 'Fältet :attribute måste innehålla minst en versal och en gemen.',
        'numbers' => 'Fältet :attribute måste innehålla minst en siffra.',
        'symbols' => 'Fältet :attribute måste innehålla minst en symbol.',
        'uncompromised' => 'Det angivna :attribute har dykt upp i en dataläckage. Välj ett annat :attribute.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'phone' => 'telefon',
        'address' => 'adress',
        'start_date_option' => 'startdatum alternativ',
        'consent_type' => 'samtyckestyp',
        'birth_month' => 'födelsemånad',
